            ...
            <div className="space-y-3">
              ...
              {Object.entries(emotionCounts)
                ...
                .map(([em, cnt]) => {
                  ...
                  const isTopEmotion = cnt === maxCount;
                  ...
                  return (
                    ...
                    <div
                      ...
                      className={`flex items-center gap-3 rounded-lg px-2 py-1 transition
                        ${isTopEmotion ? "bg-primary/10 border border-primary/20" : ""}
                      `}
                    >

                      <span
                        className={`w-16 text-xs text-right capitalize
                          ${isTopEmotion ? "text-primary font-bold" : "text-muted-foreground"}
                        `}
                      >
                        {em}
                      </span>
                      ...
                      <div className="flex-1 h-2.5 bg-foreground/5 rounded-full overflow-hidden">
                        ...
                        <div
                          className={`h-full rounded-full transition-all duration-1000
                            ${EMOTION_BAR_COLORS[em as Emotion] || "bg-muted-foreground"}
                            ${isTopEmotion ? "brightness-125 shadow-md" : ""}
                          `}
                          style={{
                            width: `${Math.round((cnt / maxCount) * 100)}%`
                          }}
                        />
              ...
              <div className="space-y-3">
                ...
                {moodHistory.slice(0, 50).map((entry) => (
                  ...
                  >
                    ...
                    <div
                      className={`w-3 h-3 rounded-full flex-shrink-0 ${EMOTION_DOT_COLORS[entry.emotion]}`}
                    />
